...
export default function Home() {
  ...
  return (
    ...
    <div id="page-content">
		...
		<div className="tt-pn-subtitle tt-sub-hero">
			<div className="tt-heading tt-heading-lg tt-heading-start margin-top-10-p margin-bottom-10-p">
		...
		<div className="tt-section padding-top-100 padding-top-lg-150">
			<div className="tt-section-inner">
				...
				<div className="position-relative">
					...
					<div id="draw-on" className="draw-on intiDraw2 anim-drawing">
						<svg  className="svg-elem-1" width="766" height="526" viewBox="0 0 766 526" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div className="content-slide-brands">
					<div className="tt-testimonials-slider ts-full-width cursor-drag ts-scale-down ts-hide-navigation anim-fadeinup" data-loop="true" data-simulate-touch="true" data-speed="900">
						
						<div className="swiper swiper-container">
							<div className="swiper-wrapper">

								<div className="swiper-slide">
									<div className="tt-brands-carousel-item">
											<figure>
								...
								<div className="swiper-slide">
									<div className="tt-brands-carousel-item">
											<figure>
												<img src="/partners/salesforce.svg" alt="Salesforce"/>
											</figure> 
											<h4>SALESFORCE</h4>
								...
								<div className="swiper-slide">
									<div className="tt-brands-carousel-item">
											<figure>
												<img src="/partners/amazon.svg" alt="Amazon"/>
											</figure> 
											<h4>AMAZON</h4>
								...
								<div className="swiper-slide">
									<div className="tt-brands-carousel-item">
											<figure>
												<img src="/partners/ibm.svg" alt="IBM"/>
											</figure> 
								...
								<div className="swiper-slide">
									<div className="tt-brands-carousel-item">
											<figure>
												<img src="/partners/fox.svg" alt="Fox"/>
											</figure> 
								...
								<div className="swiper-slide">
									<div className="tt-brands-carousel-item">
											<figure>
												<img src="/partners/willow.svg" alt="Willow"/>
											</figure> 
        ...
        <div className="tt-section padding-top-xlg-120 padding-bottom-xlg-150">
          <div className="tt-section-inner">
            ...
            <div className="tt-scrolling-text font-bold text-pink anim-fadeinup" data-scroll-speed="35">
            ...
            <div className="tt-scrolling-text font-bold text-pink scr-text-reverse anim-fadeinup" data-scroll-speed="35">
              <div className="tt-scrolling-text-inner" data-text=" Explore our projects. Explore our projects. Explore our projects.">
                Explore our projects. Explore our projects. Explore our projects.
              </div> 
            </div>
