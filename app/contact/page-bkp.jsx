  ...
  return (
    <>
        ...
        {/* <div id="page-header" className="ph-full ph-hero-about">
            <div className="page-header-inner tt-wrap-xl-xl padding-lr-xl padding-top-100">
        ...
        <div id="page-content">
                ...
                <div id="contactSection" className="margint-10-p padding-top-100 padding-bottom-100 padding-top-lg-200 padding-bottom-lg-200">
									...
									<div id="tt-contact-form" className="tt-form-minimal anim-fadeinup">
										...
										<div id="form1">
											...
											<div className="tt-form-group">
												...
												<input className="tt-form-control" type="text" name="subject" id="subject" placeholder="" aria-label="subject" required="" />
											...
											<div className="tt-form-group">
												...
												<textarea className="tt-form-control" rows="6" name="message" id="message" placeholder="" required="" />
											</div>

											<div className="tt-btn tt-btn-light-outline margin-top-40">

												<button type="button" data-hover="Send Message" id="btnSubmitComment">Send Message</button>
					...
					<div className="tt-section-contact">
						...
						<div className="tt-section-inner tt-wrap-xl" id="formJoinUs">
							...
							<div className="tt-row">
								...
								<div className="tt-col-lg-8">
									...
									<div className="tt-heading-title-contact anim-fadeinup margin-bottom-100">
										...
										<h2 className="tt-heading-title text-pink margin-bottom-50">JOIN OUR <br/>DREAM TEAM

										</h2>

										<h2 className="tt-heading-subtitle margin-bottom-70 text-white">WE ARE LOOKING FOR

											PEOPLE, NOT ROBOTS. SO TELL US WHAT MAKES YOU DIFFERENT ON A
										...
										<div id="form2">
											...
											<div className="tt-row">
												...
												<div className="tt-col-md-6">
													...
													<small className="tt-form-text"><em>Fields marked with an asterisk (*)

															are required!</em></small>
												...
												<div className="tt-col-md-6">
													...
													<div className=" margin-top-40">
														...
														<input type="file" id="fileResume" name="fileResume" multiple="" />

														<label htmlFor="fileResume">Attach Resume / CV</label>
													...
													<div className=" margin-top-40">
														...
														<input type="file" id="fileCover" name="fileCover" multiple="" />

														<label htmlFor="fileCover">Attach Cover letter</label>
													...
													<div className="tt-form-group text-right">
														...
														<div className="margin-top-xl-150">
															...
															<div className="tt-btn tt-btn-light-outline margin-top-40">
																...
																<button type="button" data-hover="Send Message" id="btnSubmitComment2">Send Message</button>
